...
* manifold
  * https://en.wikipedia.org/wiki/Manifold a manifold is not necessarily closed ??
...
### python
* create a dictionary using a list comprehensive.  Actually a dictionary comprehensive
